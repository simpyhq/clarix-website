  ...
  return (
    <div className="bg-white text-[#0a0a0a]">
      ...
      <section className="max-w-6xl mx-auto px-6 sm:px-8 pb-10">
        <Reveal>
          <div className="border border-[#e8e8e8] rounded-xl p-8 sm:p-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
              <div>
                <p className="text-[11px] font-semibold tracking-widest uppercase text-[#0066ff] mb-4">One-Time Setup</p>
                <div className="flex items-end gap-3 mb-4">
                  <span className="text-5xl sm:text-6xl font-bold text-[#0a0a0a]">$2,500</span>
                  <span className="text-[#9b9b9b] mb-2 text-[15px]">one-time</span>
                </div>
                <p className="text-[#6b6b6b] leading-relaxed mb-7 text-[15px]">
                ...
                <Link href="/intake"
                  className="inline-flex items-center gap-2 bg-[#0a0a0a] hover:bg-[#222] text-white px-6 py-3 rounded-lg font-semibold text-[14px]">
              ...
              <div className="space-y-3">
                {setupIncludes.map((item) => (
                  <div key={item} className="flex gap-3 items-start">
                    <Check size={13} className="text-[#0066ff] flex-shrink-0 mt-0.5" strokeWidth={2.5} />
                    <span className="text-[#6b6b6b] text-[13px] leading-relaxed">{item}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="max-w-6xl mx-auto px-6 sm:px-8 pb-10">
        <Reveal className="mb-6">
          <p className="text-[11px] font-semibold tracking-widests uppercase text-[#0066ff]">Monthly Plans — after setup</p>
        </Reveal>
        <Reveal stagger className="grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-2xl">
          {plans.map((plan) => (
            <div key={plan.name}
              className={`relative rounded-xl flex flex-col border ${plan.featured ? "bg-[#0a0a0a] border-[#0a0a0a] text-white" : "bg-white border-[#e8e8e8]"}`}>
              {plan.featured && (
              ...
              <div className="p-6 pt-0">
                <Link href="/intake"
                  className={`flex items-center justify-center gap-2 py-2.5 rounded-lg text-[13px] font-semibold w-full ${plan.featured ? "bg-white text-[#0a0a0a] hover:bg-white/90" : "bg-[#0a0a0a] text-white hover:bg-[#222]"}`}>
              ...
              <table className="w-full min-w-[560px]">
                <thead>
                  <tr className="bg-[#0a0a0a]">
                    ...
                    <th className="text-left text-[11px] font-semibold tracking-widests uppercase text-[#6b9bff] px-5 py-3.5 w-1/4">Clarix</th>
      ...
      <section className="max-w-3xl mx-auto px-6 sm:px-8 py-20 md:py-24">
        <Reveal className="mb-12">
          <p className="text-[11px] font-semibold tracking-widests uppercase text-[#0066ff] mb-4">FAQ</p>
      ...
      {/* CTA */}
      <section className="border-t border-[#e8e8e8] py-14">
        <Reveal>
          <div className="max-w-6xl mx-auto px-6 sm:px-8 flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-[#6b6b6b] text-[14px]">Fill out the intake form and we&apos;ll follow up within 24 hours.</p>
            </div>
            <div className="flex gap-3 flex-shrink-0">
              ...
              <Link href="/contact"
                className="inline-flex items-center gap-2 border border-[#e8e8e8] hover:border-[#0a0a0a] text-[#0a0a0a] px-6 py-3 rounded-lg font-medium text-[14px]">
                Ask a question
              </Link>
            </div>
          </div>
