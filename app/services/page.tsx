...
export default function ServicesPage() {
  return (
    <div className="bg-white text-[#0a0a0a]">
      ...
      <section className="border-t border-[#e8e8e8] bg-[#f7f7f7] py-20 md:py-24">
        <div className="max-w-6xl mx-auto px-6 sm:px-8">
          <Reveal className="mb-14">
            <p className="text-[11px] font-semibold tracking-widest uppercase text-[#0066ff] mb-4">Built For Anyone</p>
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight max-w-xl">
              Every profession. Every life.<br />
              <span className="text-[#9b9b9b]">One platform.</span>
            </h2>
            <p className="text-[#6b6b6b] text-[15px] mt-4 max-w-xl leading-relaxed">
          ...
          <Reveal stagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {useCases.map((uc) => (
              <div key={uc.role} className="bg-white border border-[#e8e8e8] rounded-xl p-5 hover:border-[#0066ff]/30 hover:shadow-sm transition-all">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-2xl">{uc.icon}</span>
                  <h3 className="font-semibold text-[#0a0a0a] text-[14px]">{uc.role}</h3>
                </div>
                <p className="text-[#6b6b6b] text-[13px] leading-relaxed">{uc.desc}</p>
              </div>
            ))}
          </Reveal>
        </div>
        ...
        <div className="space-y-0">
          {onboarding.map((s, i) => (
            <Reveal key={s.n} delay={i * 50}>
              <div className={`flex gap-6 sm:gap-10 items-start py-7 ${i !== onboarding.length - 1 ? "border-b border-[#e8e8e8]" : ""}`}>
      ...
      <section className="border-t border-[#e8e8e8] py-20 md:py-24">
        <div className="max-w-6xl mx-auto px-6 sm:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
            <Reveal>
              <p className="text-[11px] font-semibold tracking-widest uppercase text-[#0066ff] mb-4">Ongoing Service</p>
            ...
            <Reveal delay={150} className="space-y-4">
              {ongoing.map((item) => (
                <div key={item} className="flex gap-3 items-start">
                  ...
                  <p className="text-[#6b6b6b] text-[14px] leading-relaxed">{item}</p>
                </div>
              ))}
            </Reveal>
          </div>
      ...
      <section className="border-t border-[#e8e8e8] bg-[#f7f7f7] py-20 md:py-24">
        <div className="max-w-6xl mx-auto px-6 sm:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-start">
            ...
            <Reveal delay={150}>
              <div className="bg-white border border-[#e8e8e8] rounded-xl p-7 space-y-5">
                {[
      ...
      {/* CTA */}
      <section className="border-t border-[#e8e8e8] py-16">
        <Reveal>
          <div className="max-w-6xl mx-auto px-6 sm:px-8 flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-[#6b6b6b] text-[14px]">One setup fee. Monthly maintenance. No surprises.</p>
            </div>
