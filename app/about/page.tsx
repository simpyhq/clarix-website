  ...
  return (
    <div className="bg-white text-[#0f172a]">
      ...
      <section className="max-w-6xl mx-auto px-6 sm:px-8 pt-20 pb-16">
        <Reveal>
          <p className="text-[11px] font-semibold tracking-widest uppercase text-[#0f172a] mb-4">About</p>
          <h1 className="text-3xl sm:text-4xl font-medium leading-[1.08] tracking-tight mb-5 max-w-3xl">
            ...
            <span className="text-[#94a3b8]">Now available to everyone.</span>
          </h1>
        </Reveal>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 sm:px-8 pb-24">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-14 items-start">
          <Reveal className="md:col-span-3 space-y-5">
            ...
            <p className="text-[#64748b] leading-relaxed text-[15px]">
              When they started explaining it to lawyers, real estate agents, consultants, and business owners — the reaction was always the same: <em className="text-[#0f172a]">&ldquo;I want that. I have no idea how to set it up.&rdquo;</em>
            </p>
            <p className="text-[#64748b] leading-relaxed text-[15px]">
          ...
          <Reveal delay={150} className="md:col-span-2 space-y-5">
            {[
              ...
              <div key={item.label} className="border-t border-[#e2e8f0] pt-4">
                <p className="text-[11px] font-semibold tracking-widests uppercase text-[#94a3b8] mb-1">{item.label}</p>
                <p className="text-[14px] text-[#0f172a]">{item.value}</p>
              </div>
            ))}
          </Reveal>
        </div>
      ...
      <section className="border-t border-[#e2e8f0] bg-[#f8f9fa] py-20 md:py-24">
        <div className="max-w-6xl mx-auto px-6 sm:px-8">
          <Reveal className="mb-14">
            <p className="text-[11px] font-semibold tracking-widest uppercase text-[#0f172a] mb-4">The Approach</p>
          ...
          <Reveal stagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <div key={item.n} className="bg-[#f8f9fa] border border-[#e2e8f0] rounded-xl p-6">
                <span className="font-mono text-[11px] text-[#94a3b8] mb-4 block">{item.n}</span>
                <h3 className="font-medium text-[#0f172a] text-[14px] mb-2">{item.title}</h3>
      ...
      <section className="border-t border-[#e2e8f0] py-20 md:py-24">
        <Reveal>
          <div className="max-w-4xl mx-auto px-6 sm:px-8 text-center">
            ...
            <p className="text-[#64748b] text-[16px] max-w-lg mx-auto mb-10">
